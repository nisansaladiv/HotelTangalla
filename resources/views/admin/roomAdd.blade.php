    ...
    <head>
        ...
        <title></title>
            <body>
                ...
                <div class="container">
                    <h5 style="color:#b0afaf;">{{Auth::user()->name}}</h5>
                    <h1>Add Room</h1>
                    <form action="{{ route('add')}}" method="post">
                        ...
                        <div class="form-group">
                         ...
                         @endif
                            ...
                            <select class="form-control" id="exampleFormControlSelect1" name="room">
                              ...
                              <option>Family Room with Balcony</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="aco" id="formGroupExampleInput" placeholder="Example input">
                          </div>
                        </div>
                          <div class="form-group">
                            <div class="col-md-6">
                            <label for="formGroupExampleInput2">Description</label>
                            <input type="text" name="des" class="form-control" id="formGroupExampleInput2" placeholder="Another input">
                          </div>
                          </div>
                          <div class="form-group">
                            <div class="col-md-6">
                            <label for="formGroupExampleInput2">Number of Person</label>
                            <input type="text" name="nper" class="form-control" id="formGroupExampleInput2" placeholder="Another input">
                          </div>
                          </div>
                          <div class="form-group">
                            <div class="col-md-6">
                            <label for="formGroupExampleInput2">Price</label>
                            <input type="text" class="form-control" name="price" id="formGroupExampleInput2" placeholder="Another input">
                          </div>
                          </div>
